...
const DuckDBClient = () => __vitePreload(() => import("./duckdb-CcPZi1yR.js"), true ? [] : void 0).then((_2) => _2.DuckDBClient);
...
const md = () => __vitePreload(() => import("./md-DCqsG9yO.js"), true ? [] : void 0).then((_2) => _2.md);
...
define(
  ...
  },
  {
    ...
    body: (FileAttachment2) => {
      return FileAttachment2(new URL("/opa/benchmarks/assets/node-2sqbms3s85uuh6dw-Dv056Jg2.json", import.meta.url).href).json();
    },
...
define(
  ...
  },
  {
    id: 3,
    body: (FileAttachment2) => {
      return FileAttachment2(new URL("/opa/benchmarks/assets/node-10x93cm4f8cnpem6-ZvmJOVY3.json", import.meta.url).href).json();
    },
    inputs: ["FileAttachment"],
    outputs: [],
    output: "commits",
...
define(
  ...
  },
  {
    id: 4,
    body: (FileAttachment2) => {
      return FileAttachment2(new URL("/opa/benchmarks/assets/node-2wq9arc6vpxqm3ub-Bh96V3aK.json", import.meta.url).href).json();
    },
    inputs: ["FileAttachment"],
    outputs: [],
    output: "tags",

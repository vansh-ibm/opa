...
const DuckDBClient = () => __vitePreload(() => import("./duckdb-3eM6KIX-.js"), true ? [] : void 0).then((_2) => _2.DuckDBClient);
...
const md = () => __vitePreload(() => import("./md-Cf9scMfL.js"), true ? [] : void 0).then((_2) => _2.md);
...
define(
  ...
  },
  {
    ...
    body: (FileAttachment2) => {
      return FileAttachment2(new URL("/opa/benchmarks/assets/node-2sqbms3s85uuh6dw-Bykj9Rri.json", import.meta.url).href).json();
    },

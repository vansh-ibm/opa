const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Ctofcp3y.js","assets/index-cmrQR8V0.js","assets/index-DDnmNm4C.js","assets/index-DdGICwFz.js","assets/index-DenUxSEN.js","assets/index-DcVgP-2h.js","assets/index-DmBkvoSn.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DDnmNm4C.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Ctofcp3y.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DdGICwFz.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DenUxSEN.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DcVgP-2h.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DmBkvoSn.js");
        return { parser };

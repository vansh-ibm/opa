const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BvD4zFua.js","assets/index-tB3aFbpo.js","assets/index-DG8_OzqI.js","assets/index-Dtpl4drM.js","assets/index-DYmIskYC.js","assets/index-B_AzqH7m.js","assets/index-BMaOV_jD.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DG8_OzqI.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BvD4zFua.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dtpl4drM.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DYmIskYC.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B_AzqH7m.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BMaOV_jD.js");
        return { parser };
